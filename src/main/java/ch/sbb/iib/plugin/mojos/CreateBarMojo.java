...
public class CreateBarMojo extends AbstractMojo {
    ...
    public void setBarName(File barName) {
    ...
    public void setCreateBarTraceFile(File createBarTraceFile) {
        this.createBarTraceFile = createBarTraceFile;
    }
    ...
    public void setExcludeArtifactsPattern(String excludeArtifactsPattern) {
        this.excludeArtifactsPattern = excludeArtifactsPattern;
    }

    public void setIncludeArtifactsPattern(String includeArtifactsPattern) {
        this.includeArtifactsPattern = includeArtifactsPattern;
    }
    ...
    public void setToolkitInstallDir(File toolkitInstallDir) {
        this.toolkitInstallDir = toolkitInstallDir;
    }
    ...
    public void setDiscardJarsPattern(String discardJarsPattern) {
        this.discardJarsPattern = discardJarsPattern;
    }

    public void setUseClassloaders(Boolean useClassloaders) {
        this.useClassloaders = useClassloaders;
    }
}
